...
router.post('/api/send-contact', (req, res) => {
	/*
	name, email, message
	 */
	sendMail({
		toAddress: 'support@i2g.cloud',
		subject: 'I2G new contact support - ' + req.body.name + ' | ' + req.body.email,
		text: 'I2G new contact support - ' + req.body.name + ' | ' + req.body.email,
